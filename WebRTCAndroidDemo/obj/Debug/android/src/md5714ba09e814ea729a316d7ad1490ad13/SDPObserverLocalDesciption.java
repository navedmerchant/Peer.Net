...
public class SDPObserverLocalDesciption
		...
		org.webrtc.SdpObserver
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PeerNet.SDPObserverLocalDesciption, PeerJS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SDPObserverLocalDesciption.class, __md_methods);
	}


	public SDPObserverLocalDesciption () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SDPObserverLocalDesciption.class)
			mono.android.TypeManager.Activate ("PeerNet.SDPObserverLocalDesciption, PeerJS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
