...
public class RemoteSDPObserver
		...
		org.webrtc.SdpObserver
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PeerNet.RemoteSDPObserver, PeerJS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", RemoteSDPObserver.class, __md_methods);
	}


	public RemoteSDPObserver () throws java.lang.Throwable
	{
		super ();
		if (getClass () == RemoteSDPObserver.class)
			mono.android.TypeManager.Activate ("PeerNet.RemoteSDPObserver, PeerJS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
